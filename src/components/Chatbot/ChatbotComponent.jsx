...
import KNOWLEDGE_BASE_DATA from "../../data/knowledgeBase.json";const ChatbotComponent = () => {
  ...
  const [isChatOpen, setIsChatOpen] = useState(false);  // Preparing the knowledge base data
  useEffect(() => {
